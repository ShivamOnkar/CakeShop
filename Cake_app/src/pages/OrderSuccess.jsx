      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            This might happen if you refreshed the page or the order data was
            cleared.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
            ...
            {orderDetails.address && (
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border leading-relaxed space-y-1">
                  <p className="font-semibold text-gray-800">
                    {orderDetails.address.name || "Customer"}
          ...
          <div className="mt-8 p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <p className="text-green-600 text-sm">
              Your order is confirmed and being processed. You'll receive
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">
            Fresh cakes delivered to your doorstep in Amravati
          </p>
